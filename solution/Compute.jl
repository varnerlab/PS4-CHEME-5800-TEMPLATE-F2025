...
function _objective_function(w::Array{Float64,1}, ḡ::Array{Float64,1}, 
    ...
    f = w'*(Σ̂*w) + (1/(2*ρ))*((sum(w) - 1.0)^2 + (ḡ'*w - R)^2) - (1/μ)*sum(_safe_log.(w));

    # TODO: This version does NOT have the barrier term for this implementation
...
function solve(model::MySimulatedAnnealingMinimumVariancePortfolioAllocationProblem; 
    ...
    while has_converged == false
        ...
        for _ in 1:KL
            ...
            # TODO: If you wan to get rid of the barrier term, comment out the next line
